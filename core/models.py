...
class Prueba(models.Model):
	...
	userAction = models.CharField(max_length = 300, verbose_name = 'Accion del usuario' )
	expectedResult = models.CharField(max_length = 300, verbose_name = 'Resultado esperado' )
	result = models.CharField(max_length = 300, verbose_name = 'Resultado Obtenido')
